...
export async function generateMetadata({
  ...
  const description = `Premium ceramic window tinting in ${c.name}, MI by our experts. Up to 99% UV protection, infrared heat rejection, and a lifetime warranty. Serving ${c.name} and Metro Detroit. Free quote: (313) 729-0005.`;
  return {
    title,
    description,
