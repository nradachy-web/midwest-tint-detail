...
// ---------------- HERO ----------------
export const HERO = {
  eyebrow: "150+ Five-Star Reviews · Plymouth, MI · Lifetime Tint Warranty",
  ...
  badges: ["Lifetime Warranty", "150+ Five-Star Reviews", "Ceramic Heat Rejection"],
} as const;
...
export const REVIEWS = {
  heading: "Trusted by 150+ Five-Star Customers",
...
export const FAQ = [
  ...
  },
  {
    ...
    a: "We are not the cheapest, and that is on purpose. You get work installed by our experts, premium ceramic film, 150+ five-star reviews, and a lifetime warranty. It is the shop you only pay once.",
  },
] as const;
...
export const SERVICE_DETAILS: Record<string, ServiceDetail> = {
  ...
  "paint-correction": {
    ...
    whyUs: [
      ...
      "Local Plymouth shop trusted by 150+ five-star customers",
    ],
  },
  "ceramic-coating": {
    id: "ceramic-coating",
...
export const SEO: Record<string, { title: string; description: string }> = {
  home: {
    ...
    description:
      "Premium ceramic window tinting in Plymouth, MI, by our experts. Up to 99% UV protection, serious heat rejection, and a lifetime warranty. 150+ five-star reviews. Free quote: (313) 729-0005.",
  },
  "window-tint": {
  ...
  about: {
    ...
    description:
      "Midwest Tint & Detail is a locally owned Plymouth, MI, shop led by our experts. Premium ceramic tint, paint correction, coating, and detailing, backed by a lifetime warranty and 150+ five-star reviews.",
  },
  contact: {
...
export const CITIES: City[] = [
  ...
  },
  {
    ...
    intro: [
      ...
      "Premium ceramic film, honest recommendations for your vehicle, and a lifetime warranty on every install. That is how we earn Westland customers for the long haul.",
    ],
